                    ...
                    <div className="flex-1 max-w-md hidden md:block">
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-4 py-2 pl-10 pr-4 text-sm border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] focus:border-transparent bg-gray-50"
                                disabled
